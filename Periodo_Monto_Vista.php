        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <li><a href="dashboard.php">INICIO</a></li>
           ...
           <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li class="active"><a href="Periodo_Monto_Vista.php">A partir del Monto</a></li>
  ...
  <div class="panel-body">
      ...
      <div class="row">
        <div class="col-md-6 col-xs-8">
          ...
          <hr/>
					<div class="form-group">
						<label for="inputPassword3" class="col-sm-2 col-xs-4 control-label">Monto</label>
						<div class="col-sm-4 col-xs-8">
						      <div class="input-group">
    ...
    <script type="text/javascript" src="js/periodo_Monto.js"></script>
